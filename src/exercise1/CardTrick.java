 ...
 *
 * @author dancye
 * @author Jainishkumar Raval feb 2, 2024 
 */
public class CardTrick {
    ...
    private static void printInfo() {
        ...
        System.out.println("My name is Jainishkumar Raval, but you can call me Jainish");
        System.out.println();
        
        System.out.println("My career ambitions:");
        System.out.println("-- Getting good marks and most of the knowledge!");
	System.out.println("-- Getting my Dream Job.");
	System.out.println();	
